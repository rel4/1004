...
//修改地址
public class PersonaldataAmendressActivity_ extends BaseAppCompatActivity implements View.OnTouchListener, OnPersonalDataDeleteAddressListener, OnPersonalDataSaveAddressListener {
    ...
    private TextView tv_spProvince, tv_spCity, tv_spArea;
    ...
    private void initView() {
        ...
        et_personaldata_amend_user.setText(intent.getStringExtra("收货人"));
        et_personaldata_amend_tel.setText(intent.getStringExtra("手机号码"));
       ...
       xian = intent.getStringExtra("xian");
        ...
        if ("Y".equals(aDefault) && aDefault != null) {
            ...
            switch (view.getId()) {
                ...
                case R.id.btn_personaldataamend_tltle://保存
                    ...
                    if (TextUtils.isEmpty(et_personaldata_amend_user.getText().toString())) {
                        ...
                        mRequestSave.personalDataSaveAddressRequests(uid, s, is_default, id, PersonaldataAmendressActivity_.this);

                        System.out.println("===========is_default==========" + uid + "s==>" + s + "is_default==>" + is_default + "id==>" + id);
                ...
                case R.id.ibtn_personaldata_amendaddress_delete://删除所有
                    ...
                    mdialog.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            mRequest.personalDataDeleteAddressRequests(getIntent().getStringExtra("uid"), getIntent().getStringExtra("id"), PersonaldataAmendressActivity_.this);
                        }
                    });
    ...
    private void setupViewsListener() {
        mSpProvince.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1,
                ...
                tv_spProvince.setVisibility(View.GONE);
                if (isFirstLord) {
        ...
        mSpCity.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1,
                                       int arg2, long arg3) {
                // TODO Auto-generated method stub
                tv_spCity.setVisibility(View.GONE);
                if (!isFirstLord) {
        ...
        mSpArea.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1,
                ...
                tv_spArea.setVisibility(View.GONE);
            }

            @Override
            public void onNothingSelected(AdapterView<?> arg0) {
                // TODO Auto-generated method stub
                mCurrentAreaName = xian;
            }
        });
    }
