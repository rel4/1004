...
public class NotifyActivity extends BaseAppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(R.string.title_activity_notify);
        ...
        //绑定控件
        webview = (ProgressBarWebView) findViewById(R.id.notify_webview);
