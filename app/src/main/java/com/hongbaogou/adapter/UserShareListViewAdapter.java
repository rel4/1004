...
public class UserShareListViewAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    private List<BeanUserShare> list = new ArrayList<BeanUserShare>();
    ...
    public BeanUserShare getObjectByPosttion(int position) {
    ...
    @Override
    public BeanUserShare getItem(int position) {
        return list.get(position);
    }
    ...
    private void setData2UI(View convertView, int position) {
        ...
        BeanUserShare listBean = list.get(position);
